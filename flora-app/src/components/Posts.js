            ...
            <div>
                <Container>
                    <Row className="center">
                        ...
                        <Col xs={3} md={1}> <FaRegComment style={{fontSize: "2em"}}/> 20</Col>
                    </Row>
                    ...
                    <Row className="center">
                        ...
                        <Col xs={3} md={1}> <FaRegComment style={{fontSize: "2em"}}/> 42</Col>
                    </Row>
                    ...
                    <Row className="center">
                        ...
                        <Col xs={3} md={1}> <FaRegComment style={{fontSize: "2em"}}/> 5</Col>
                    </Row>
                </Container>
            </div>
