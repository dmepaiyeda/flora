        ...
        return(
            <div className="imageLanding" style={{backgroundImage: `url(${cover})` }}>
                <Container>
                    ...
                    <span><FaRegComment style={{fontSize: "2em"}}/>  20 replies</span>
                    </Row>
                </Container>
                

                <div style={{backgroundColor:"rgba(240, 235, 207, 0.42)"}}>
                    <Container>
                        <Row>
                            <Col md={1}><Image src={doctor} fluid/></Col>
                            <Col md={5}>
                                <Row>
                                    <Col style={{paddingRight:"0px"}}><h5 style={{paddingRight:"0px"}}>Dr. Jane Tripathi, MD </h5> </Col>
                                    <Col><Image style={{width: "10%", paddingLeft:"0px"}} src={star} fluid/></Col>
                                </Row>
                                <p>
